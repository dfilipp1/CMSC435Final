...
void k_mean_clustering(vector<POINT> * points, vector<CLUSTER>*clust, int cluster_nums);
 ...
 */
CLUSTER_POINT *load_points( char * file_name, int cluster_nums){
  ...
  k_mean_clustering(points, clusters, cluster_nums);
  //cout<<"The number of file is: "<<num_of_points<<endl;
  //cout<<"The number of cluster is: "<<num_of_cluster<<endl;
  CLUSTER_POINT * cluster_points = new CLUSTER_POINT();
  cluster_points->points = points;
  cluster_points->clusters = clusters;
 ...
 */
void k_mean_clustering(vector<POINT> * coordPoint, vector<CLUSTER>*clust, int cluster_nums){
  
  vector<POINT> *points = coordPoint;
  vector<CLUSTER> * clusters = clust;
